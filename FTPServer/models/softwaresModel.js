...
module.exports ={
 ...
 console.log(sql);
    ...
    getByApplication: function(callback){
		var sql = "select * from softwares WHERE type='Application' ";
        db.getResults(sql, function(results){
        callback(results);
        });
    },
    getByUtility: function(callback){
		var sql = "select * from softwares WHERE type='Utility' ";
        db.getResults(sql, function(results){
        callback(results);
        });
    },
    getByDriver: function(callback){
		var sql = "select * from softwares WHERE type='Driver' ";
        db.getResults(sql, function(results){
        callback(results);
        });
	},
